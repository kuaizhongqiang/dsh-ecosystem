...
| [dsh-cli](dsh-cli.md) | 伞仓内目录 | L1.5 入口层(终端 CLI + 本机工具服务:给别的 agent 调 dsh) | 0.1.0 | — | [→](dsh-cli.md) |
| [deepseek-harness](deepseek-harness.md) | **git 子模块** | L2 核心(dsh 本体,官方只读) | `46a7f68b` | — | [→](deepseek-harness.md) |
